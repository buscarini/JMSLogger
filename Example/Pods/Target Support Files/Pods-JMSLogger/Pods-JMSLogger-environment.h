...
// JMSLogger
#define COCOAPODS_POD_AVAILABLE_JMSLogger
#define COCOAPODS_VERSION_MAJOR_JMSLogger 0
#define COCOAPODS_VERSION_MINOR_JMSLogger 2
#define COCOAPODS_VERSION_PATCH_JMSLogger 0
